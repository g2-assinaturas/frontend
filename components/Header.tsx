...
/**
 * Header: Navegação fixa profissional com logo, links autenticados e controles de tema/autenticação
 * - Logo com gradiente à esquerda
 * - Links (Planos, Dashboard) apenas visíveis em desktop e se autenticado
 * - ThemeToggle + botões de auth à direita
 * - Backdrop blur e borda sutil
 */
          ...
          {!isAuthenticated ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-md border border-[var(--border)] bg-zinc-100 px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium text-zinc-700 shadow-sm
