    ...
    <main className="flex min-h-screen items-center justify-center bg-ink-50 px-6 py-12">
      <div className="w-full max-w-md rounded-3xl border border-ink-100 bg-white p-8 shadow-card">
        <div className="mb-6 space-y-2 text-center">
          <p className="text-sm font-semibold uppercase tracking-wide text-ink-500">Super Admin</p>
          <h1 className="text-2xl font-semibold text-ink-900">Acesso restrito</h1>
          <p className="text-sm text-ink-600">Gestão de empresas e utilizadores.</p>
        </div>
